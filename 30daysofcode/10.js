function countConsecutiveOnes(n) {
	...
	// loop through each digit to see if there are consecutive 1's. If num[i] is 1, count++, if not, push count into final array to keep track of current batch of 1's, reset count to 0
	...
	final.push(count);
	// go through final and print largest number in array
